...
<?php include "partes/busca_opcoes.php" ?>
    <span id="indicativo-modo">Modo Vendas</span>
    ...
    <div id="painel-edicao-pdt">
        ...
        <div id="linha-master">
            ...
            <form method="POST" id="formulario-salvamento" action="salvar.php">
                ...
                <button onclick="salvar('index.php')" id="btn-salvar"><i class="fa fa-save" style="font-size:22px;"></i></button>
            </form>
        </div>
        <br><br>
        <script>
        ...
        <div id="linha-2">
            <div id="valores-comercio" onclick="verValores()">
                ...
                <b>Venda:</b>
                <span id="valor-venda" name="valor-venda" type="text"></span><br>
                <b>Total Investido:</b>
        ...
        */
        ...
        document.onkeydown = function(e) {
            ...
            if (e.which == 16 && pressedCtrl == true) {
               ...
               //window.alert(JSON.stringify(pdsPorId));
        ...
        function salvar(linkDirecionado) {
            document.getElementById("refazer-array").setAttribute("value", JSON.stringify(acoesRefazer));
            document.getElementById("desfazer-array").setAttribute("value", JSON.stringify(acoesDesfazer));
            document.getElementById("dados-navegacao").setAttribute("value", JSON.stringify(dadosNavegacao));
